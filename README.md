...
The book provides a practical guide to genome polarisation using the [`diemr`](https://github.com/nmartinkova/diemr) R package. It explains how to:
...
Each chapter includes example code and interpretation notes based on the *diagnostic index expectation maximisation (diem)* algorithm described in [Baird *et al.* (2023)](https://doi.org/10.1111/2041-210X.14010).
