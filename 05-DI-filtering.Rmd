...
knitr::include_graphics("figs/testdata-all.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = '100%'}
knitr::include_graphics("figs/testdata-DI40.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = '100%'}
knitr::include_graphics("figs/hist.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = '100%'}
knitr::include_graphics("figs/HI.png")
```
